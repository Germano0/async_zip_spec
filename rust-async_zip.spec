...
%doc %{crate_instdir}/SPECIFICATION.md
%{crate_instdir}/
...
%package     -n %{name}+full-wasm-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+full-wasm-devel %{_description}

This package contains library source intended for building other packages which
use the "full-wasm" feature of the "%{crate}" crate.

%files       -n %{name}+full-wasm-devel
%ghost %{crate_instdir}/Cargo.toml
